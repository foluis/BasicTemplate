...
namespace NA.Template.Web.Stores
{
       ...
       IUserTwoFactorStore<ApplicationUser>, IUserPasswordStore<ApplicationUser>, IUserRoleStore<ApplicationUser>
    {
        ...
        public async Task<IdentityResult> CreateAsync(ApplicationUser user, CancellationToken cancellationToken)
        {
            ...
            user.Id = await _applicationUserRepository.CreateApplicationUser(user, cancellationToken);
        ...
        public async Task<ApplicationUser> FindByNameAsync(string normalizedUserName, CancellationToken cancellationToken)
        {
            ...
            var user = await _applicationUserRepository.GetUserByNormalizedUserName(normalizedUserName, cancellationToken);
        ...
        public async Task<IList<string>> GetRolesAsync(ApplicationUser user, CancellationToken cancellationToken)
        {
            ...
            var list = await _applicationUserRepository.GetUserRoles(user, cancellationToken);
